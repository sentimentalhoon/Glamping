...
const ABOUT_DATA = {
    story: {
        ...
        paragraphs: [
            ...
            "2021년 첫 손님을 맞이한 이후, 더 웨스턴 글램핑은 '빛나는 추억을 만드는 곳'이라는 이름처럼 수많은 가족, 연인, 친구들의 소중한 순간들을 함께해 왔습니다.",
    ...
    team: {
        title: "더 웨스턴 팀",
        greeting:
            "안녕하세요, 더 웨스턴 글램핑을 운영하고 있는 대표입니다. 저희 팀은 고객 여러분께 최고의 글램핑 경험을 제공하기 위해 항상 노력하고 있습니다. 무엇이든 불편한 점이 있으시면 언제든지 말씀해 주세요. 더 웨스턴에서 빛나는 추억을 만들어 가시길 바랍니다.",
    },
    stats: [
