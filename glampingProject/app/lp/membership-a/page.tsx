    ...
    <main className="min-h-screen bg-background text-foreground">
      <section className="bg-primary text-primary-foreground">
        <div className="container-width py-6 flex items-center justify-between">
          <Link href="/" className="font-serif text-xl tracking-wider uppercase">
            The Western
          </Link>
          <a
            href="#lead-form"
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-primary/95 to-primary">
        <div className="container-width py-20 md:py-28 text-white">
          <p className="text-secondary uppercase tracking-[0.2em] text-xs font-semibold mb-4">
            Membership Private Offer
          </p>
          <h1 className="font-serif text-4xl md:text-6xl leading-tight mb-6 break-keep">
            프리미엄 글램핑 회원권,
            <br />
            당신의 라이프스타일에 맞춰 설계합니다.
          </h1>
          <p className="max-w-3xl text-white/80 text-lg leading-relaxed break-keep mb-10">
        ...
        <div className="container-width grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <div className="space-y-6">
            ...
            <div className="pt-6 border-t border-border/60">
              <h3 className="text-xl font-semibold text-primary mb-4">상담 진행 절차</h3>
          ...
          <div className="bg-surface border border-border rounded-2xl p-6 md:p-8 shadow-lg">
            <h3 className="font-serif text-2xl text-primary mb-2">무료 상담 신청</h3>
